...
![o]({{ site.url }}/images/week/4/mill/1.jpg) ![image]({{ site.url }}/images/week/4/mill/2.jpg)

I used :

- 1/64" inch bit for milling the traces

![0]({{ site.url }}/images/week/4/mill/fabisp_cmp.png)

- 1/32" inch bit for cut the fab isp key out of the "copper sheet"

![0]({{ site.url }}/images/week/4/mill/fabisp_drd.png)
...
![o]({{ site.url }}/images/week/4/solder/fabisp_bom.jpg)

![o]({{ site.url }}/images/week/4/solder/fabisp_tbrd.png)

![o]({{ site.url }}/images/week/4/mill/fabisp_cmp.png) 

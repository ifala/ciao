...
- fade led [Fade_C]({{ site.url }}/images/week/7/Fade_C.zip) - [video]() SUCCESS!
- only blink on press button - [blink]({{ site.url }}/images/week/7/blink.zip) - [video]() SUCCESS!
- blink x time on press button - [irina]({{ site.url }}/images/week/7/irina.zip) - [video]() SUCCESS!
- fade led only on press button - [button_fade]({{ site.url }}/images/week/7/button_fade_C.zip) - [video]() FAIL!
...
- Led ON by press button [Button_ledon]({{ site.url }}/images/week/7/arduinoIDE/Button_ledon/Button_ledON.ino) - [video]() SUCCESS!
- LED - [led]() - [video]({{ site.url }}/images/week/7/arduinoIDE/led/led.ino) SUCCESS!
- Blink led - [Blink]() - [video]({{ site.url }}/images/week/7/arduinoIDE/Blink/Blink.ino) SUCCESS!
- Fade change on press button - [fadechange]({{ site.url }}/images/week/7/arduinoIDE/fadechange/fadechange.ino)

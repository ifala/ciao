...
- [My website github file <i class="fa fa-github"></i>](https://github.com/ifala/ifala.github.io)
- [Original template hmfaysal website  <i class="fa fa-github"></i>](https://github.com/hmfaysal/Notepad)
- [custom.css <i class="fa fa-file-code-o"></i>]({{ site.url }}/images/week/1/file/custom.css)
